...
export default function MapPage() {
  ...
  // A specific saved search highlights the neighborhoods it's limited to (if
  // any) so you can see the area you're actually searching, not just the
  // listings that happened to match so far.
  const highlightNeighborhoods = useMemo(() => {
    if (scope === ALL_WATCHES_SCOPE || scope === "") return [];
